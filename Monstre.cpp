...
void Monstre::Init()
{
	...
	m_Chute.NbFrame = 9;
	m_Chute.Frame = { 0,45,90,135,180,225,270,315,360 };
	m_Chute.Frame_Inv = { 10,8,7,6,5,4,3,2,1 };
	m_Chute.TimeWait ={ 0.100,0.080,0.060,0.010,0.010 ,0.010 ,0.010 ,0.010,0.010 }; // { 1,1,1,1,1,1,1,1,1 };/
	m_Chute.Pos = { 10,15,20,30,30,30,30,30,30 };
